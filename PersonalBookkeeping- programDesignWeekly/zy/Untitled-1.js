...
MongoClient.connect(url, { useNewUrlParser: true }, function(err, db) {
    ...
    var data = [
        ...
        { id: 121, time: '2019-03-18', type: '餐饮费', pay_type: '支付宝', num: 45, note: '无', pay: '收入' },
        { id: 122, time: '2019-03-19', type: '生活日用', pay_type: '支付宝', num: 66, note: '无', pay: '收入' },
        { id: 123, time: '2019-03-19', type: '餐饮费', pay_type: '现金', num: 34, note: '无', pay: '收入' },
        { id: 124, time: '2019-03-20', type: '文教娱乐', pay_type: '支付宝', num: 90, note: '无', pay: '收入' },
        { id: 125, time: '2019-03-20', type: '餐饮费', pay_type: '现金', num: 20, note: '无', pay: '收入' },
        { id: 126, time: '2019-03-21', type: '服饰美容', pay_type: '支付宝', num: 198, note: '无', pay: '收入' },
        { id: 127, time: '2019-03-21', type: '其他消费', pay_type: '支付宝', num: 233, note: '无', pay: '收入' },
        { id: 128, time: '2019-03-21', type: '交通出行', pay_type: '银行卡', num: 500, note: '无', pay: '收入' },
        { id: 129, time: '2019-03-22', type: '餐饮费', pay_type: '支付宝', num: 35, note: '无', pay: '收入' },
        { id: 130, time: '2019-03-22', type: '生活日用', pay_type: '现金', num: 89, note: '无', pay: '收入' },
        { id: 131, time: '2019-03-23', type: '文教娱乐', pay_type: '支付宝', num: 167, note: '无', pay: '收入' },
        { id: 132, time: '2019-03-23', type: '餐饮费', pay_type: '现金', num: 136, note: '无', pay: '收入' },
        { id: 133, time: '2019-03-24', type: '服饰美容', pay_type: '现金', num: 398, note: '无', pay: '收入' },
        { id: 134, time: '2019-03-24', type: '其他消费', pay_type: '现金', num: 156, note: '无', pay: '收入' },
        { id: 135, time: '2019-03-25', type: '生活日用', pay_type: '支付宝', num: 300, note: '无', pay: '收入' },
        { id: 136, time: '2019-03-25', type: '服饰美容', pay_type: '支付宝', num: 100, note: '无', pay: '收入' },
        { id: 137, time: '2019-03-26', type: '住房缴费', pay_type: '现金', num: 600, note: '无', pay: '收入' },
        { id: 138, time: '2019-03-26', type: '餐饮费', pay_type: '现金', num: 23, note: '无', pay: '收入' },
        { id: 139, time: '2019-03-27', type: '通讯物流', pay_type: '支付宝', num: 12, note: '无', pay: '收入' },
        { id: 140, time: '2019-03-27', type: '生活日用', pay_type: '现金', num: 45, note: '无', pay: '收入' },
        { id: 141, time: '2019-03-28', type: '住房缴费', pay_type: '支付宝', num: 199, note: '无', pay: '收入' },
        { id: 142, time: '2019-03-28', type: '交通出行', pay_type: '支付宝', num: 4, note: '无', pay: '收入' },
        { id: 143, time: '2019-03-28', type: '服饰美容', pay_type: '现金', num: 34, note: '无', pay: '收入' },
        { id: 144, time: '2019-03-29', type: '交通出行', pay_type: '支付宝', num: 21, note: '无', pay: '收入' },
        { id: 145, time: '2019-03-29', type: '餐饮费', pay_type: '现金', num: 69, note: '无', pay: '收入' },
        { id: 146, time: '2019-03-29', type: '餐饮费', pay_type: '支付宝', num: 21, note: '无', pay: '收入' },
        { id: 147, time: '2019-03-30', type: '生活日用', pay_type: '现金', num: 499, note: '无', pay: '收入' },
        { id: 148, time: '2019-03-30', type: '服饰美容', pay_type: '支付宝', num: 450, note: '无', pay: '收入' },
        { id: 149, time: '2019-03-31', type: '文教娱乐', pay_type: '现金', num: 500, note: '无', pay: '收入' },
        { id: 150, time: '2019-03-31', type: '餐饮费', pay_type: '支付宝', num: 129, note: '无', pay: '收入' },
    ]
    dbo.collection("zy").insertMany(data, function(err, res) {
        if (err) throw err;
